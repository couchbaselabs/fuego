...
func NewFuego(storeName string, storeConfig map[string]interface{}, analysisQueue *index.AnalysisQueue) (index.Index, error) {
	rv := &Fuego{
		version:       Version,
...
func (udc *Fuego) batchRows(writer store.KVWriter, addRowsAll [][]FuegoRow, updateRowsAll [][]FuegoRow, deleteRowsAll [][]FuegoRow) (err error) {
...
func (udc *Fuego) mergeOldAndNew(backIndexRow *BackIndexRow, rows []index.IndexRow) (addRows []FuegoRow, updateRows []FuegoRow, deleteRows []FuegoRow) {
...
func (udc *Fuego) storeField(docID []byte, field document.Field, fieldIndex uint16, rows []index.IndexRow, backIndexStoredEntries []*BackIndexStoreEntry) ([]index.IndexRow, []*BackIndexStoreEntry) {
...
func (udc *Fuego) indexField(docID []byte, includeTermVectors bool, fieldIndex uint16, fieldLength int, tokenFreqs analysis.TokenFrequencies, rows []index.IndexRow, backIndexTermEntries []*BackIndexTermEntry) ([]index.IndexRow, []*BackIndexTermEntry) {
...
func (udc *Fuego) termVectorsFromTokenFreq(field uint16, tf *analysis.TokenFreq, rows []index.IndexRow) ([]*TermVector, []index.IndexRow) {
